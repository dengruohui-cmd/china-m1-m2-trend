...
def generate_chart(df):
    ...
    ax.plot(df['date_dt'], df['m2'] / 10000,
            linewidth=2.5, color='#2E86AB', marker='o', markersize=2, label='M2 (广义货币)')
    ax.plot(df['date_dt'], df['m1'] / 10000,
            linewidth=2, color='#E76F51', marker='s', markersize=2, label='M1 (狭义货币)')
    ax.set_title('中国M1/M2货币供应量月度趋势（2016-2026）', fontsize=16, fontweight='bold', pad=20)
    ...
    ax.annotate(f'M2: {latest["m2"]/10000:.1f}万亿',
                ...
                xytext=(5, 10), textcoords='offset points', fontsize=9, color='#2E86AB')
    ax.annotate(f'M1: {latest["m1"]/10000:.1f}万亿',
                xy=(latest['date_dt'], latest['m1']/10000),
                xytext=(5, -15), textcoords='offset points', fontsize=9, color='#E76F51')
